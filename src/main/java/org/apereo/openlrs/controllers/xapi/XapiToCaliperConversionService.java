...
import org.apereo.openlrs.model.event.v2.Actor;
import org.apereo.openlrs.model.event.v2.Event;
import org.apereo.openlrs.model.event.v2.Group;
import org.apereo.openlrs.model.event.v2.Object;
import org.apereo.openlrs.model.event.v2.SubOrganizationOf;
...
public class XapiToCaliperConversionService {
  ...
  public Event fromXapi(Statement statement) {
    ...
    return new Event(Context.CONTEXT.getValue(), 
